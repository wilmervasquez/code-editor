...
<div class="view">
  ...
  <div class="">
    <form action="" class="flex flex-col gap-2 p-2">
      ...
      <button onclick={onSend} class="flex items-center justify-center gap-2 w-full bg-neutral-900 border border-neutral-700 rounded-lg p-1 pr-2 shadow-lg shadow-black">
        {#if ver == 'verifiend'}
